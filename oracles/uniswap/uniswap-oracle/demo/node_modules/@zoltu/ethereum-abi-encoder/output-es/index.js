// signature parsing
export function parseSignature(functionSignature) {
...
export function generateFullSignature(functionDescription) {
    return `${functionDescription.name}(${toFullParameters(functionDescription.inputs)})`;
}
export function generateCanonicalSignature(functionDescription) {
...
export function decodeMethod(first, second, bytes) {
...
export function decodeParameters(descriptions, data) {
    let offset = 0;
    const decoded = {};
...
export function encodeMethod(first, second, parameters) {
    if (typeof first === 'number')
...
export function encodeParameters(descriptions, parameters) {
...
// events
export async function decodeUnknownEvent(keccak256, abi, topics, data) {
...
export function decodeEvent(eventDescription, topics, data) {
