...
export function wireEncodeByteArray(bytes) {
    let result = '';
    for (let i = 0; i < bytes.length; ++i) {
...
export function wireEncodeNumber(value, padding = 0) {
    if (value < 0)
...
export function wireEncodeBlockTag(tag) { return (typeof tag === 'string') ? tag : wireEncodeNumber(tag); }
export function wireEncodeOffChainTransaction(transaction) {
    return {
...
export function wireEncodeOnChainTransaction(transaction) {
    return {
