...
function validateByteArray(message) {
...
exports.validateByteArray = validateByteArray;
...
function bigintToBytes(value, numberOfBytes) {
...
function rightCircularShift64(value, bits) {
    value = value % 2n ** 64n;
    bits = bits % 64n;
...
exports.rightCircularShift64 = rightCircularShift64;
function leftCircularShift64(value, bits) {
    value = value % 2n ** 64n;
    bits = bits % 64n;
...
exports.leftCircularShift64 = leftCircularShift64;
function modularSubtract(minuend, subtrahend, fieldModulus) {
    const difference = (minuend - subtrahend) % fieldModulus;
    return (difference >= 0) ? difference : difference + fieldModulus;
}
exports.modularSubtract = modularSubtract;
function modularDivide(dividend, divisor, fieldModulus) {
    return dividend * modularMultiplicitiveInverse(divisor, fieldModulus) % fieldModulus;
}
exports.modularDivide = modularDivide;
function modularMultiplicitiveInverse(base, fieldModulus) {
...
exports.modularMultiplicitiveInverse = modularMultiplicitiveInverse;
function getFirstBits(data, numberOfBits) {
    if (numberOfBits > 32)
...
exports.getFirstBits = getFirstBits;
...
exports.bitArrayToNumber = bitArrayToNumber;
