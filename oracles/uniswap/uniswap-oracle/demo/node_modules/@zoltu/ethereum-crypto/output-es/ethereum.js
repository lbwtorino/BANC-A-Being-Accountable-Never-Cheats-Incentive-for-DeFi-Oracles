 ...
 */
export async function addressToChecksummedString(address) {
 ...
 */
export async function validateAddressChecksum(addressString) {
 ...
 */
export async function signRaw(privateKey, message) {
 ...
 */
export function mutateMessageForSigning(message) {
    message = (typeof message === 'string') ? new TextEncoder().encode(message) : message;
 ...
 */
export async function mutateAndSign(privateKey, message) {
 ...
 */
export async function functionSignatureToSelector(functionSignature) {
