...
contract('Incentive', function(accounts) {
    it("test wrong source", function() {
        var proof_punish_4_wrong_methodology = Punisher.submit_punishment_4_wrong_methodology();
        console.log(proof_punish_4_wrong_methodology)
        return manifest.deployed().then(function(manifestInstance) {
            return manifestInstance.getInfor.call().then(function(manifestValue){
                return incentive.deployed().then(function(incentiveInstance) {
                    ...
                    return incentiveInstance.punish(accounts[1], 4, proof_punish_4_wrong_methodology[0], 0, 0, proof_punish_4_wrong_methodology[1], '', proof_punish_4_wrong_methodology[2].v, proof_punish_4_wrong_methodology[2].r, proof_punish_4_wrong_methodology[2].s, {from: accounts[4]}).then(function(punishRes){
                        ...
                        return incentiveInstance.getInfor.call().then(function(punishValue){
                            ...
                            var proof_dispute_4_wrong_methodology = Oracle.submit_dispute_4_wrong_methodology();
                            ...
                            return incentiveInstance.dispute(4, proof_dispute_4_wrong_methodology[0], 0, 0, proof_dispute_4_wrong_methodology[1], '', proof_dispute_4_wrong_methodology[2].v, proof_dispute_4_wrong_methodology[2].r, proof_dispute_4_wrong_methodology[2].s, {from: accounts[1]}).then(function(disputeRes){
                                ...
                                return incentiveInstance.getInfor.call().then(function(disputeValue){
                                    ...
                                    var vote_resolve_4_wrong_methodology = WatchTowerA.submit_resolve_4_wrong_methodology();
                                    var oracle_WTA = WTStorageA.getItem("oracle")
                                    return incentiveInstance.resolve(oracle_WTA, 4, vote_resolve_4_wrong_methodology[0], vote_resolve_4_wrong_methodology[1].v, vote_resolve_4_wrong_methodology[1].r, vote_resolve_4_wrong_methodology[1].s, {from: accounts[3]}).then(function(resolveRes){
