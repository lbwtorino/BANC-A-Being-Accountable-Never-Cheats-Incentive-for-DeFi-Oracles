...
contract('Incentive', function(accounts) {
    it("test late report", function() {
        var proof_punish_1_late_report = Punisher.submit_punishment_1_late_report();
        ...
        return manifest.deployed().then(function(manifestInstance) {
            return manifestInstance.getInfor.call().then(function(manifestValue){
                return incentive.deployed().then(function(incentiveInstance) {
                    ...
                    return incentiveInstance.punish(accounts[1], 1, proof_punish_1_late_report[0], 0, proof_punish_1_late_report[1], '', '', proof_punish_1_late_report[2].v, proof_punish_1_late_report[2].r, proof_punish_1_late_report[2].s, {from: accounts[4]}).then(function(punishRes){
                        ...
                        return incentiveInstance.getInfor.call().then(function(punishValue){
                            ...
                            var proof_dispute_1_late_report = Oracle.submit_dispute_1_late_report();
                            // function punish(address oracle, uint behavior, uint time, uint time_rapid, uint price, bytes prices, bytes sources, byte _v, bytes32 _r, bytes32 _s) public {
                            return incentiveInstance.dispute(1, proof_dispute_1_late_report[0], 0, proof_dispute_1_late_report[1], '', '', proof_dispute_1_late_report[2].v, proof_dispute_1_late_report[2].r, proof_dispute_1_late_report[2].s, {from: accounts[1]}).then(function(disputeRes){
                                ...
                                return incentiveInstance.getInfor.call().then(function(disputeValue){
                                    ...
                                    var vote_resolve_1_late_report = WatchTowerA.submit_resolve_1_late_report();
                                    var oracle_WTA = WTStorageA.getItem("oracle")
                                    return incentiveInstance.resolve(oracle_WTA, 1, vote_resolve_1_late_report[0], vote_resolve_1_late_report[1].v, vote_resolve_1_late_report[1].r, vote_resolve_1_late_report[1].s, {from: accounts[3]}).then(function(resolveRes){
